...
public class DefaultLogFormat implements LogFormat {
    ...
    public void printSubjectLog(Subject subject, int intent, Thread thread) {
        if (thread == null || subject.getThread() == thread) {
            ...
            printStream.println(String.join("", Collections.nCopies(intent, "	")) + str.italics().framed());
        }
    }
    ...
    public void printSubject(int intent, Logable logable) {
        printStream.println(String.join("", Collections.nCopies(intent, "	")) +
    ...
    public DefaultLogFormat(ConsoleStr.RGB rgb) {
        this.CYAN = rgb;
    }

    public DefaultLogFormat(ConsoleStr.RGB rgb, PrintStream printStream) {
        this.CYAN = rgb;
